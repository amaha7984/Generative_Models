...
MODEL_CONFIGS = {
    "imagenet": {
        ...
        "out_channels": 3,
        "num_res_blocks": 2, #3
        "attention_resolutions": [4, 8], #[2, 4, 8]
        "dropout": 0.1,
        "channel_mult": [1, 2, 3, 4],
        "num_classes": None, #Actual "num_classes": 1000
        "use_checkpoint": False,
        "num_heads": 4,
        "num_head_channels": 48, #64
...
def instantiate_model(architecture: str, is_discrete: bool, use_ema: bool):
    assert (
